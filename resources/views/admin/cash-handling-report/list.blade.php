    ...
    <div class="container-fluid">
        <div class="inner-body">
            ...
            <div class="page-header d-block">
                <h2 class="main-content-title tx-24 mg-b-5">Cash Handling Reports</h2>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="{{ url('admin/dashboard') }}">Dashboard</a></li>
                    <li class="breadcrumb-item"><a href="{{ route('admin.cash-handling.index') }}">Reports</a></li>
                    <li class="breadcrumb-item active" aria-current="page">All Cash Handling</li>
                </ol>
            </div>
            {{-- ------------------------------------------------ --}}
                    ...
                    <div class="card custom-card">
                        <div class="card-body">
                            ...
                            <div class="d-flex justify-content-between align-items-center mb-4">
                                <h6 class="main-content-label">Cash Handling Reports</h6>
