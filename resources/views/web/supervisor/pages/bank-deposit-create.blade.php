        ...
        <section class="dashboard-title-section bg-white border-b border-gry-50 bg-white">
            <div class="container-fluid">
                <div class="dashboard-inner flex items-center justify-between gap-[10px] flex-wrap py-[10px]">
                    <h1 class="h6 text-gry-800">Create Bank Deposit</h1>
                    <div class="breadcrumb flex items-center gap-[10px] flex-wrap">
                        ...
                        <span class="text-gry-300">/</span>
                        <a href="{{ route('supervisor.bankDeposit') }}" class="body-14 text-gry-800 bold">Bank Deposit</a>
                        <span class="text-gry-300">/</span>
                        <span class="body-14 text-gry-800">Create Bank Deposit</span>
                    </div>
                </div>
            </div>
        </section>
        <section class="dashboard-content py-[15px] md:py-[30px] flex-1">
            <div class="container-fluid">
                <div class="bg-white white-box">
                    ...
                    <form action="{{ route('supervisor.bankDepositStore') }}" method="POST">
                        @csrf
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div class="form-group">
                                <label class="form-label block mb-1">Amount Deposited<span class="text-red-500">*</span></label>
                                <input type="text" name="amount" value="{{ old('amount') }}" placeholder="Enter amount deposited"
                            ...
                            <div class="form-group">
                                <label class="form-label block mb-1">Bank Name<span class="text-red-500">*</span></label>
                            ...
                            <div class="form-group">
                            <label class="form-label block mb-1">Deposit Date<span class="text-red-500">*</span></label>
                            <div class="relative">
                                <input
                                    type="text"
                                    id="customDate"
                            ...
                            @enderror
                             ...
                             <div class="form-group">
                                <label class="form-label block mb-1">Depositor Name<span class="text-red-500">*</span></label>
                                <input type="text" name="depositor_name" value="{{ old('depositor_name') }}" placeholder="Enter depositor name"
                                    class="form-control w-full border border-gray-300 rounded px-3 py-2" />
                            ...
                            <div class="form-group">
                                <label class="form-label block mb-1">Reference Number<span class="text-red-500">*</span></label>
                                <input type="text" name="reference_number" value="{{ old('reference_number') }}" placeholder="Enter reference number"
                                    class="form-control w-full border border-gray-300 rounded px-3 py-2" />
