...
@section('content')
            ...
            <div class="container-fluid">
                <div class="dashboard-inner flex items-center justify-between gap-[10px] flex-wrap py-[10px]">
                    ...
                    <div class="breadcrumb flex items-center gap-[10px] flex-wrap">
                        ...
                        <span class="body-14 text-gry-800 bold">Stock Overview</span>
                        <span class="text-gry-300">/</span>
            ...
            <div class="container-fluid">
                ...
                <div class="search-record-box flex items-center justify-between flex-wrap gap-[15px] mb-[15px]">
                    <div class="search-box relative max-w-[390px] w-full">
                        <select name="warehouse_id" id="warehouseSelect" class="form-control !pr-[50px] w-full appearance-none">
                    ...
                    <div class="date-record-btn w-full md:w-auto flex items-center gap-[15px] flex-wrap md:flex-nowrap">
                        <a href="{{ route('supervisor.warehouse-levels') }}" class="btn btn-secondary">Clear Filter</a>
                    </div>
                </div>
                    ...
                    <div class="overflow-x-auto">
                        <table class="w-full whitespace-nowrap text-sm text-left text-gray-600" id="stocksTable">
                            ...
                            <tbody class="divide-y divide-gray-100 body-14-regular text-gry-500">
                                @include('web.supervisor.warehouse_levels.partials.stocks_table', [
                                    'stocks' => $stocks,
                                ])
                            </tbody>
                        </table>
    ...
    <script>
        document.getElementById('warehouseSelect').addEventListener('change', function() {
            ...
            let url = "{{ route('supervisor.warehouse-levels') }}";
            ...
            fetch(url, {
                ...
                .then(data => {
                    ...
                    // Re-attach pagination click handlers for AJAX
                    attachPaginationHandlers();
                })
                .catch(error => console.error('Error:', error));
        });

        // Function to handle pagination clicks via AJAX
                ...
                link.addEventListener('click', function(e) {
                    ...
                    fetch(url, {
                        ...
                        .then(data => {
                            ...
                            // Re-attach handlers for new pagination links
                            attachPaginationHandlers();

                            // Scroll to top of table
                            document.querySelector('.white-box').scrollIntoView({ behavior: 'smooth' });
                        })
                        .catch(error => console.error('Error:', error));
                });
            });
