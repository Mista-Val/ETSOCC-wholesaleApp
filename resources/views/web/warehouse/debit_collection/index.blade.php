...
@section('content')
    ...
    <main class="dashboard-screen-bg relative">
        ...
        <section class="dashboard-content py-[15px] md:py-[30px] flex-1">
            <div class="container-fluid">
                {{-- <form method="GET" action="{{ route('warehouse.debtCollections') }}" class="search-record-box flex items-center justify-between flex-wrap gap-[15px] mb-[15px]">
            ...
            <div class="date-record-btn w-full md:w-auto flex items-center gap-[15px] flex-wrap md:flex-nowrap">
               ...
               /> 
                <a href="{{ route('warehouse.debtCollections') }}" class="btn btn-secondary">Clear Filter</a>
                 <a href="{{ route('warehouse.debtCollections-create') }}" class="btn btn-primary">
                        Create Debt Collection
                    </a>
            </div>
         </form> --}}

                <form method="GET" action="{{ route('warehouse.debtCollections') }}"
