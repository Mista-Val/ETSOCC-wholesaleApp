...
class DownPaymentController extends Controller
{
    ...
    public function downPayment(Request $request)
    {
        ...
        return view('web.outlet.down_payment.index', compact(
            'datas',
            'totalDownPayment',
    ...
    {
        $users = Customer::all();
        return view('web.outlet.down_payment.create', compact('users'));
    }

    /**
     * Store new down payment
     */
    ...
    //         $userOutlet->increment('balance', $request->amount);
    //     }

    //     return redirect()->route('outlet.downPayment')
    //         ->with('success', 'Down payment created successfully.');
    // }
