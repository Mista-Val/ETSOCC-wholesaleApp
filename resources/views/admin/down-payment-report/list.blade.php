    ...
    <div class="container-fluid">
        <div class="inner-body">
            ...
            <div class="page-header d-block">
                <h2 class="main-content-title tx-24 mg-b-5">Down Payment Reports</h2>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="{{ url('admin/dashboard') }}">Dashboard</a></li>
                    <li class="breadcrumb-item"><a href="{{ route('admin.down-payment.index') }}">Reports</a></li>
                    <li class="breadcrumb-item active" aria-current="page">All Down Payment</li>
                </ol>
            </div>
                    ...
                    <div class="card custom-card">
                        <div class="card-body">
                            ...
                            <div class="d-flex justify-content-between align-items-center mb-4">
                                <h6 class="main-content-label">Down Payment Reports</h6>
                                ...
                                <table class="table table-bordered card-table w-100">
                                    ...
                                    <tbody>
                                        @forelse ($payments as $payment) <tr>
                                            ...
                                            <td><span class="badge badge-pill badge-success-light">{{ $payment->coustomer->phone_number ?? 'N/A' }}</span></td>
                                            <td><span class="badge badge-pill badge-warning-light">{{ $payment->coustomer->address ?? 'N/A' }}</span></td>
