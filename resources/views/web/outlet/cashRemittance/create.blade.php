        ...
        <div class="container-fluid">
            <div class="dashboard-inner flex items-center justify-between gap-[10px] flex-wrap py-[10px]">
                ...
                <div class="breadcrumb flex items-center gap-[10px] flex-wrap">
                    ...
                    <span class="text-gry-300">/</span>
                    <a href="{{route('outlet.cashRemittance')}}"><span class="body-14 text-gry-800 bold">Cash Remittance</span></a>
                    <span class="text-gry-300">/</span>
                    <span class="body-14 text-gry-800">Create Cash Remittance</span>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="dashboard-content py-[15px] md:py-[30px] flex-1">
        <div class="container-fluid">
            <div class="bg-white white-box p-6 rounded shadow-sm">
                ...
                <form action="{{ route('outlet.cashRemittance-store') }}" method="POST">
                    @csrf
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <!-- Amount -->
                        <div class="form-group">
                            <label class="form-label block mb-1">Amount Being Remitted</label>
                    ...
                    <div class="form-group mt-4">
                        ...
                        <textarea name="remark" rows="4" placeholder="Enter Remark"
                            class="form-control w-full border border-gray-300 rounded px-3 py-2">{{ old('remark') }}</textarea>
                        @error('remark')
                            <div class="text-red-500 text-sm mt-1">{{ $message }}</div>
                        @enderror
                    </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Auto-fill role when receiver is selected
    ...
    // Trigger on page load if there's an old value (for validation errors)
