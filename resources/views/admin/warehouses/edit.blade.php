  ...
  <div class="container-fluid">
    <div class="inner-body">
      ...
      <div class="page-header d-block">
        <h2 class="main-content-title tx-24 mg-b-5">Edit Warehouse</h2>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="{{ url("admin/dashboard") }}">Dashboard</a></li>
          <li class="breadcrumb-item"><a href="{{ route('admin.warehouses.index') }}">Warehouses</a>
          </li>
        ...
        <div class="col-lg-12">
          <div class="card custom-card">
            <div class="card-body">
              ...
              {{-- Edit Form --}}
              {!! Form::model($warehouse, ['route' => ['admin.warehouses.update', $warehouse->id], 'method' => 'PUT'])
              !!}
              <div class="row">
                <div class="col-md-6">
