        ...
        <section class="dashboard-title-section bg-white border-b border-gry-50 bg-white">
            <div class="container-fluid">
                <div class="dashboard-inner flex items-center justify-between gap-[10px] flex-wrap py-[10px]">
                    <h1 class="h6 text-gry-800">Sale Detail</h1>
                    <div class="breadcrumb flex items-center gap-[10px] flex-wrap">
                        ...
                        <span class="body-14 text-gry-800 bold">Sales</span>
                        <span class="text-gry-300">/</span>
                        <span class="body-14 text-gry-800">Sale Detail</span>
                    </div>
                </div>
            </div>
        </section>
        ...
        <section class="dashboard-content py-[15px] md:py-[30px] flex-1">
            <div class="container-fluid">
                <div class="white-box">
                    <div
                        ...
                        <div class="flex gap-[15px] flex-col">
                            <div class="border-b flex flex-col gap-[5px] border-disabled-gry-100 pb-[15px]">
                                <p class="body-16-regular text-gry-900">Sale ID</p>
                                <p class="body-16-semibold text-gry-900">#{{ $sale->id }}</p>
                            </div>

                            <div class="border-b flex flex-col gap-[5px] border-disabled-gry-100 pb-[15px]">
                                <p class="body-16-regular text-gry-900">Customer</p>
                                <p class="body-16-semibold text-gry-900">{{ ucwords($sale->customer->name ?? 'N/A') }}</p>
                            </div>

                            <div class="border-b flex flex-col gap-[5px] border-disabled-gry-100 pb-[15px]">
                                <p class="body-16-regular text-gry-900">Location</p>
                                <p class="body-16-semibold text-gry-900">{{ ucwords($sale->location->name ?? 'N/A') }}</p>
                            </div>
                            ...
                            @if (!empty($sale->remark))
                                <div class="flex flex-col gap-[5px]">
                                    <p class="body-16-regular text-gry-900">Remark</p>
                                    <p class="body-16-semibold text-gry-900">{{ ucfirst($sale->remark) }}</p>
                                </div>
                            @endif
                        </div>
                    </div>
                    ...
                    <!-- Sold Products List -->
                    <div>
                        <h2 class="h6 mb-2">Sold Products</h2>
                            ...
                            <table class="w-full whitespace-nowrap text-sm text-left text-gray-600">
                                <thead class="text-gry-900 semibold body-14-regular uppercase border-b border-[#E9E9E9]">
                                    <tr>
                                        ...
                                        <th class="px-6 py-3">Per Unit Price</th>
                                ...
                                <tbody class="divide-y divide-gray-100 body-14-regular text-gry-500">
                                    ...
                                    @empty
                                        <tr>
                                            <td colspan="5" class="px-6 py-3 text-center text-gray-400">
                                                No sold products found for this sale.
                                            </td>
                                        </tr>
                                    @endforelse
                                </tbody>
