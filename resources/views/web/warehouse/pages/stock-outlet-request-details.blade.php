        ...
        <section class="dashboard-title-section bg-white border-b border-gry-50">
            <div class="container-fluid">
                <div class="dashboard-inner flex items-center justify-between gap-[10px] flex-wrap py-[10px]">
                    <h1 class="h6 text-gry-800">Outlet Stock Request Detail</h1>
                    <div class="breadcrumb flex items-center gap-[10px] flex-wrap">
                       <a href="{{ route('warehouse.dashboard') }}">
                        ...
                        <span class="text-gry-300">/</span>
                        <a href="{{ route('warehouse.outletStockRequest') }}" class="body-14 text-gry-800 bold">Stock Outlet Request</a>
                        <span class="text-gry-300">/</span>
                        <span class="body-14 text-gry-800">Stock Outlet Request Details</span>
                    </div>
                </div>
            </div>
        </section>
                    ...
                    <div
                        ...
                        <div class="flex gap-[15px] flex-col">
                            ...
                            <div class="border-b flex flex-col gap-[5px] border-disabled-gry-100 pb-[15px]">
                                <p class="body-16-regular text-gry-900">Request ID</p>
                                <p class="body-16-semibold text-gry-900">#{{ $transferStock->id }}</p>
                            </div>

                            <div class="border-b flex flex-col gap-[5px] border-disabled-gry-100 pb-[15px]">
                                <p class="body-16-regular text-gry-900">Outlet Name</p>
                                <p class="body-16-semibold text-gry-900">{{ ucfirst($transferStock->senderOutlet->name) ?? '-' }}
                                </p>
                            </div>
