        ...
        <section class="dashboard-content py-[15px] md:py-[30px] flex-1">
            ...
            <div class="date-record-btn w-full md:w-auto flex items-center gap-[15px] flex-wrap md:flex-nowrap">
               ...
               /> 
                ...
                <form method="GET" action="{{ route('warehouse.downPayment') }}"
                    ...
                    <div class="date-record-btn w-full md:w-auto flex items-center gap-[15px] flex-wrap md:flex-nowrap">
                        ...
                        <a href="{{ route('warehouse.downPayment') }}" class="btn btn-secondary">Clear Filter</a>
                        <a href="{{ route('warehouse.downPayment-create') }}" class="btn btn-primary">
                            Create Down Payment
                        </a>
                    </div>
                </form>
