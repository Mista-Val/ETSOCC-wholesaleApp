        ...
        <div class="container-fluid">
            <div class="inner-body">
                ...
                <div class="page-header d-block">
                    <h2 class="main-content-title tx-24 mg-b-5">External Cash Inflow Details</h2>
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{ url('admin/dashboard') }}">Dashboard</a></li>
                        <li class="breadcrumb-item"><a href="{{ route('admin.external-cash-inflow.index') }}">External Cash
                                Inflows</a></li>
                    ...
                    <div class="col-lg-12">
                        <div class="card custom-card">
                            <div class="card-body">
                                ...
                                {{-- Inflow Info --}}
                                <h4 class="mb-4">Inflow Information</h4>
                                <table class="table table-bordered">
                                    ...
                                    <tr>
                                        <th>Received Date</th>
                                        {{-- Assuming received_date is cast as a Carbon instance --}}
                                ...
                                <div class="text-right mt-4">
                                    <a href="{{ route('admin.external-cash-inflow.index') }}" class="btn btn-secondary">
