    ...
    <div class="container-fluid">
        <div class="inner-body">
            <div class="page-header d-block">
                <h2 class="main-content-title tx-24 mg-b-5">Outlet</h2>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="{{ url('admin/dashboard') }}">Dashboard</a></li>
                    <li class="breadcrumb-item"><a href="{{ route('admin.outlets.index') }}">Outlets</a></li>
                    <li class="breadcrumb-item active" aria-current="page">All Outlets</li>
                </ol>
            </div>
                    ...
                    <div class="card custom-card">
                        <div class="card-body">
                            ...
                            <div class="d-flex justify-content-between align-items-center mb-4">
                                <h6 class="main-content-label">outlets</h6>
                                <div class="d-flex align-items-center">
                                    ...
                                    <a href="{{ route('admin.outlets.create') }}" class="btn ripple btn-main-primary">Add New</a>
                                </div>
                            </div>
                            ...
                            <div class="table-responsive" wire:loading.remove wire:target="search">
                                <table class="table table-bordered card-table w-100">
                                    <thead>
                                        <tr>
                                            ...
                                            <th width="30%">Assigned Manager</th>
                                            ...
                                            <td class="text-center">
                                                <div class="btn-toolbar table-actions" role="toolbar" aria-label="Toolbar with button groups">
                                                    <div class="btn-group btn-group-sm" role="group" aria-label="Second group">
                                                         <a href="{{ route('admin.outlets.show', $item->id) }}"
                                                                type="button" class="btn view"data-toggle="tooltip"
                                                                data-placement="top" data-html="true"
                                                                title='<strong>View</strong>'>
                                                                <i class="fa fa-eye"></i>
                                                            </a>
                                                        <a href="{{ route('admin.outlets.edit', $item->id) }}" type="button" class="btn edit" data-toggle="tooltip" data-placement="top" data-html="true" title='<strong>Edit</strong>'>
                                ...
                                <div class="d-flex justify-content-between align-items-center mt-3">
                                    <div>Total Records : {{ $outlets->total() }}</div>
