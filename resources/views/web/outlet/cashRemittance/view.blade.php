            ...
            <div class="container-fluid">
                <div class="dashboard-inner flex items-center justify-between gap-[10px] flex-wrap py-[10px]">
                    ...
                    <div class="breadcrumb flex items-center gap-[10px] flex-wrap">
                        ...
                        <span class="text-gry-300">/</span>
                       <a href="{{route('outlet.cashRemittance')}}"><span class="body-14 text-gry-800">Cash Remittance</span></a> 
                           <span class="text-gry-300">/</span>
                    ...
                    <div
                        ...
                        <div class="flex gap-[15px] flex-col">
                            ...
                            <div class="border-b flex flex-col gap-[5px] border-disabled-gry-100 pb-[15px]">
                                ...
                                <p class="body-16-semibold text-gry-900">{{ ucfirst($datas->coustomer->name) ?? '' }}</p>
                            </div>
                            ...
                            <div class="border-b flex flex-col gap-[5px] border-disabled-gry-100 pb-[15px]">
                                ...
                                <p class="body-16-semibold text-gry-900">{{ucfirst ($datas->remarks) }}
                                </p>
                            </div>
                            {{-- <div class="border-b flex flex-col gap-[5px] border-disabled-gry-100 pb-[15px]">
                           ...
                           <div class="flex flex-wrap gap-[10px] justify-between">
                             <div class="flex flex-col gap-[5px]">
                                    ...
                                    @if ($datas->status == 'pending') text-[var(--color-status-warning-800)]
                                    @elseif($datas->status == 'rejected') text-[var(--color-secondary-400)]
                                    @elseif($datas->status == 'accepted') text-[var(--color-status-success-700)] @endif">
