                ...
                <div class="col-md-12">
                    <div class="card custom-card">
                        <div class="card-body">
                            ...
                            {!! Form::open(array('route' => 'admin.banners.store','method' => 'POST','enctype'=>'multipart/form-data')) !!}
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-5">
                                    {!! Form::text('sub_title', null, ['class' => 'form-control' ,'placeholder' => 'Enter Sub Title', 'required'=>"required"]) !!}
                                    <div class="text-danger">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-12 mt-2 p-0">
                                        <img src="{{asset('img/logo.png')}}" class='d-none'  id="current_img" style="">
                                    </div>
                                    </div>
