        ...
        <section class="dashboard-title-section bg-white border-b border-gry-50">
            <div class="container-fluid">
                <div class="dashboard-inner flex items-center justify-between gap-[10px] flex-wrap py-[10px]">
                    <h1 class="h6 text-gry-800">Request from Outlets</h1>
                    <div class="breadcrumb flex items-center gap-[10px] flex-wrap">
                        ...
                        <span class="text-gry-300">/</span>
                         <a href="{{route('outlet.outlet-transfer-request')}}"><span class="body-14 text-gry-800 bold">Request from Outlets  </span></a>
                        <span class="text-gry-300">/</span>
                       <span class="body-14 text-gry-800">Request from Outlets Detail</span>
                    </div>
                </div>
            </div>
        </section>
                    ...
                    <div
                        ...
                        <div class="flex gap-[15px] flex-col">
                            ...
                            <div class="border-b flex flex-col gap-[5px] border-disabled-gry-100 pb-[15px]">
                             ...
                             <div class="border-b flex flex-col gap-[5px] border-disabled-gry-100 pb-[15px]">
                                <p class="body-16-regular text-gry-900">To</p>
                            ...
                            <div class="flex flex-wrap gap-[10px] justify-between">
                                <div class="flex flex-col gap-[5px]">
                                    ...
                                    @elseif($transferStock->status == 'accepted') text-[var(--color-secondary-400)]
                                    @elseif($transferStock->status == 'rejected') text-[var(--color-status-success-700)] @endif">
