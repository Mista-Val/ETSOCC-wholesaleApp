                ...
                <div class="space-y-6">
                        ...
                        <div class="grid gap-4 md:grid-cols-3 lg:grid-cols-4">
                            <div class="bg-white rounded-[16px] shadow-[0px_1px_78px_rgba(0,0,0,0.06)] p-4 flex flex-col">
                                ...
                                <div class="mt-2 flex items-center gap-[10px] flex-wrap">
                                    <div class="flex-1 flex flex-col gap-[5px]">
                                        ...
                                        <span class="h5  text-gry-800">${{ $todaySalesAmount }}</span>
                                    </div>
                            ...
                            <div class="bg-white rounded-[16px] shadow-[0px_1px_78px_rgba(0,0,0,0.06)] p-4 flex flex-col">
                                ...
                                <div class="mt-2 flex items-center gap-[10px] flex-wrap">
                                    <div class="flex-1 flex flex-col gap-[5px]">
                                        <span class="semibold text-gry-400">Cash</span>
                                        <span class="h5 text-gry-800">${{ $todayTotalCashSaleCollection }}</span>
                                    </div>
                    ...
                    <div class="current-stock-levels">
                        ...
                        <div class="grid gap-4 md:grid-cols-3">
                            <div class="bg-white rounded-[16px] shadow-[0px_1px_78px_rgba(0,0,0,0.06)] p-4 flex flex-col">
                                <span class="body-18 semibold text-gry-800">Stock received from warehouse</span>
                                <div class="mt-2 flex items-center gap-[10px] flex-wrap">
                                    <div class="flex-1 flex flex-col gap-[5px]">
                            ...
                            <div class="bg-white rounded-[16px] shadow-[0px_1px_78px_rgba(0,0,0,0.06)] p-4 flex flex-col">
                                <span class="body-18 semibold text-gry-800">Current stock levels in outlet</span>
                                <div class="mt-2 flex items-center gap-[10px] flex-wrap">
                                    <div class="flex-1 flex flex-col gap-[5px]">
                    ...
                    <div class="balances-summary">
                        ...
                        <div class="grid gap-4 md:grid-cols-3">
                            ...
                            <div class="bg-white rounded-[16px] shadow-[0px_1px_78px_rgba(0,0,0,0.06)] p-4 flex flex-col">
                                ...
                                <div class="mt-2 flex items-center gap-[10px] flex-wrap">
                                    <div class="flex-1 flex flex-col gap-[5px]">
                                        <span class="h5 text-gry-800">{{ $totalPendingRequestUnits }} units</span>
                                    </div>
