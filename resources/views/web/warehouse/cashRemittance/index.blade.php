...
@section('content')
    ...
    <main class="dashboard-screen-bg relative">
        ...
        <section class="dashboard-content py-[15px] md:py-[30px] flex-1">
            <div class="container-fluid">
                <form method="GET" action="{{ route('warehouse.cashRemittance') }}"
                    ...
                    <div class="date-record-btn w-full md:w-auto flex items-center gap-[15px] flex-wrap md:flex-nowrap">
                       ...
                       /> -->
                        ...
                        <a href="{{ route('warehouse.cashRemittance') }}" class="btn btn-secondary">Clear Filter</a>
                        <a href="{{ route('warehouse.cashRemittance-create') }}" class="btn btn-primary">
                                ...
                                @forelse($datas as $transfer)
                                    <tr class="hover:bg-gray-50">
                                        ...
                                        <td class="px-6 py-3 text-center">
                                            <a href="{{ route('warehouse.cashRemittance-view', $transfer->id) }}"
