...
<main class="dashboard-screen-bg relative">
    ...
    <section class="dashboard-content py-[15px] md:py-[30px] flex-1">
        <div class="container-fluid">
               <form method="GET" action="{{ route('outlet.recordExpenses') }}" class="search-record-box flex items-center justify-between flex-wrap gap-[15px] mb-[15px]">
            ...
            <div class="date-record-btn w-full md:w-auto flex items-center gap-[15px] flex-wrap md:flex-nowrap">
               ...
               /> -->
               <a href="{{ route('outlet.recordExpenses') }}" class="btn btn-secondary">Clear Filter</a>
                 <a href="{{ route('outlet.recordExpenses-create') }}" class="btn btn-primary">
